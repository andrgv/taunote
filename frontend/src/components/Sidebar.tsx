    ...
    return (
        <aside className="w-64 bg-sidebar p-4 flex flex-col justify-between rounded-r-lg shadow-lg h-screen">
                                    ...
                                    {group.audioProjects.map((audioProject) => (
                                        <li
                                            ...
                                            className={`flex items-center p-2 rounded-md cursor-pointer transition-colors duration-200 ${
                                                selectedGroupId === group.id && selectedAudioProjectId === audioProject.id
                                                    ? 'bg-inputBg'
                                                    : 'hover:bg-inputBg'
                                            }`}
                                            onClick={() => onSelectAudioProject(group.id, audioProject.id)}
                                        >
            ...
            <div className="border-t border-gray-700 pt-4">
                <a href="#" className="flex items-center p-2 rounded-md hover:bg-inputBg text-gray-300 transition-colors duration-200">
